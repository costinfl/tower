...
public class HtmlReleaseDocumentRenderer {
    ...
    public String render(ReleaseDocument document) {
        ...
        out.append("<footer>Generated by Tower from the Canonical Model. This document is a view of that ")
                .append("model, not a source of truth (BR-07), and can be regenerated at any time.</footer>\n")
                .append("</body>\n</html>\n");
